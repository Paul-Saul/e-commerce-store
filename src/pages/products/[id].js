...
import { stripe } from "src/utils/stripes";
         ...
         <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="w-full flex-1 max-w-md border border-opacity-50 rounded-md shadow-lg p-6 bg-white">
               ...
               <p className="pt-2 flex items-center space-x-2">
                  <CheckBadgeIcon className="text-lime-500 w-5 h-5" />
               ...
               <button
                 onClick={onAddToCart} 
                 className="w-full mt-4 border border-lime-500 py-2 px-6 bg-lime-500 hover:bg-lime-600 hover:border-lime-600 focus:ring-4 focus:ring-opacity-50 foucs:ring-lime-500 text-white disabled:opacity-50 disabled:cursor-not-allowed rounded-md">
                  Add to cart
               </button>
            </div>
         </div>
